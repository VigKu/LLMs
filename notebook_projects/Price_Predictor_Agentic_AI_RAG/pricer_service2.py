...
PROJECT_NAME = "pricer"
HF_USER = "Vikool" #"ed-donner" # your HF name here! Or use mine if you just want to reproduce my results.
RUN_NAME = "2025-10-05_13.32.27" #"2024-09-13_13.04.39"
